...
while True:
    ...
    #load test images
    """test_img1 = cv2.imread("opencv_frame_11.png")
    test_img2 = cv2.imread("opencv_frame_2.png")
    test_img3 = cv2.imread("opencv_frame_3.png")
    test_img4 = cv2.imread("opencv_frame_0.png")
    test_img5 = cv2.imread("opencv_frame_1.png")"""
    ...
    #cv2.imshow("testing", cv2.resize(predicted_img2, (400, 500)))
    #cv2.imshow("testing", cv2.resize(predicted_img3, (400, 500)))
    #cv2.imshow("testing", cv2.resize(predicted_img4, (400, 500)))
    key=cv2.waitKey(1)
    if key==ord("q"):
        break
video.release()
